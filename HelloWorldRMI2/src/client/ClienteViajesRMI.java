...
public class ClienteViajesRMI {
    ...
    public static int menu(Scanner teclado) {
        ...
        System.out.println("6. Registrar notificaciones");
        System.out.println("7. Desregistrar notificaciones");
        do {
    ...
    public static void main(String[] args) throws IOException, NotBoundException {
        ...
        //try {
            ...
            ImplClienteViaje c = new ImplClienteViaje();
            ...
            do {
                ...
                switch (opcion) {
                    ...
                    case 6: { //Registrarse notificación
                        System.out.println("Introduce el origen del viaje al que quieres registrarte: ");
                        String origen = scanner.nextLine(); // Lo guardamos en una variable
                        h.registerForCallback(origen, c);
                        System.out.println("Registrado correctamente");
                        break;
                    }
                    case 7: {
                        System.out.println("Introduce el origen del viaje al que quieres desregistrarte: ");
                        String origen = scanner.nextLine(); // Lo guardamos en una variable
                        h.unregisterForCallback(origen, c);
