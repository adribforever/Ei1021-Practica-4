...
// TODO: ARREGLADO
        ...
        JSONArray nuevos = (JSONArray) jsonViaje.get("pasajeros");
        for (Object nuevo : nuevos) passengers.add((String) nuevo);
        pasajeros = passengers;
        
        codviaje = (String) jsonViaje.get("codviaje");
    ...
    public JSONObject toJSON() {
        ...
        j.put("codprop", codprop);
        j.put("origen", origen);
        j.put("destino", destino);
        j.put("fecha", fecha);
        j.put("precio", precio);
        j.put("numplazas", numplazas);
        j.put("pasajeros", pasajeros);
        j.put("codviaje", codviaje);
        // POR IMPLEMENTAR hecho
        return j; // MODIFICAR
    }
